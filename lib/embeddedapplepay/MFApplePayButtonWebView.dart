...
class MFApplePayButtonWebView extends State<MFApplePayButton> {
  ...
  MFApplePayButtonWebView(double height, {this.radius = 8, this.buttonText, this.isLoadingIndicatorHidden = false}) {
...
<a id="btnSubmitApplePay" class="applePay pay-now btnApplePay btn apple-pay-btn">
  ...
  void executePayment(BuildContext context, String sessionId) {
    ...
    MFSDK.callExecutePaymentForInAppApplePay(context, request, apiLang, callback);
  }
  ...
  void buildLoad(MFInitiateSessionResponse initiateSession,
    ...
    apiLang = lang;
    callback = func;
    _webViewController!.loadUrl(urlRequest: URLRequest(url: Uri.parse(Uri.encodeFull(url))));
      }
  void load(MFInitiateSessionResponse initiateSession,
      MFExecutePaymentRequest req, String lang, Function func) {
        buildLoad(initiateSession, req, lang, func);
  }
  void loadWithStartLoading(MFInitiateSessionResponse initiateSession,
      MFExecutePaymentRequest req, String lang, Function startLoading, Function func) {
