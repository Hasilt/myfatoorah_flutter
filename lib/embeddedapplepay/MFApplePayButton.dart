...
class MFApplePayButton extends StatefulWidget {
  ...
  MFApplePayButton({
    ...
    this.mfInAppApplePayWebView = MFApplePayButtonWebView(height, radius: radius, buttonText: buttonText, isLoadingIndicatorHidden: isLoadingIndicatorHidden);
  }
  ...
  void loadWithStartLoading(MFInitiateSessionResponse initSessionResponse,
      MFExecutePaymentRequest request, String apiLang, Function startLoading, Function callback) {
    mfInAppApplePayWebView!
        .loadWithStartLoading(initSessionResponse, request, apiLang, startLoading, callback);
  }
}
